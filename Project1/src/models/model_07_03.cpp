...
class ModelFactory_07_03 : public IModelFactory
{
public:
	~ModelFactory_07_03() { }
...
void Models_07_03::draw(RenderContext& renderContext)
{
	m_models.at(static_cast<size_t>(m_dispModelNo))->Draw(renderContext);
}

void Models_07_03::debugRenderParams()
{
