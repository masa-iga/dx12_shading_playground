...
class ModelFactory_10_05 : public IModelFactory
{
public:
	~ModelFactory_10_05() { }
...
class Models_10_05 : public IModels
{
public:
	Models_10_05() { m_models.resize(static_cast<size_t>(ModelType::kSize)); }
	~Models_10_05() { }
...
std::unique_ptr<IModels> ModelFactory_10_05::create(RenderContext& renderContext)
{
	std::unique_ptr<Models_10_05> m(new Models_10_05);
	{
...
void Models_10_05::resetCamera()
{
	;
}

void Models_10_05::createModel([[maybe_unused]] RenderContext& renderContext)
{
	{
...
namespace ModelHandler {
	std::unique_ptr<IModels> loadModelForChap10_05(RenderContext& renderContext)
	{
		ModelFactory_10_05 factory;
