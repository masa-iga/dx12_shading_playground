...
class ModelFactory_12_03 : public IModelFactory
{
public:
	~ModelFactory_12_03() { }
...
private:
	...
	const std::string kTkmSampleFile = "Sample_12_03/Sample_12_03/Assets/modelData/sample.tkm";
	std::string getTkmSampleFilePath() { return ModelUtil::getPathFromAssetDir(kTkmSampleFile); }
	const std::string kFxModelFile = "./Assets/shader/sample_12_03_model.fx";
	std::string getFxModelFilePath() { return kFxModelFile; }
	const std::string kFxSpriteFile = "Sample_12_03/Sample_12_03/Assets/shader/sprite.fx";
...
std::unique_ptr<IModels> ModelFactory_12_03::create(RenderContext& renderContext)
{
...
void Models_12_03::createModel([[maybe_unused]] RenderContext& renderContext)
{
	// create Gbuffer
	{
...
void Models_12_03::debugRenderParams()
{
	{
		{
...
namespace ModelHandler {
	std::unique_ptr<IModels> loadModelForChap12_03(RenderContext& renderContext)
	{
		ModelFactory_12_03 factory;
