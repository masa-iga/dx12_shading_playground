...
class ModelFactory_14_04 : public IModelFactory
{
public:
	~ModelFactory_14_04() { }
...
class Models_14_04 : public IModels
{
public:
	Models_14_04() { }
	~Models_14_04()
...
void Obserber_14_04::update(WPARAM wParam, [[maybe_unused]] LPARAM lParam)
{
	switch (wParam) {
	case VK_SPACE:
		m_paused = !m_paused;
...
void Models_14_04::addObserver()
{
	WinMgr::addObserver(&m_obserber);
}

void Models_14_04::removeObserver()
{
	WinMgr::removeObserver(&m_obserber);
}

void Models_14_04::handleInput()
{
...
void Models_14_04::draw(RenderContext& renderContext)
{
	{
...
void Models_14_04::debugRenderParams()
{
	{
		{
