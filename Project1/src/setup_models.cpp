...
#include "models/model_16_04.h"
#include "models/model_17_01.h"
...
#define LOAD_MODEL_CHAP_16_03 (0)
#define LOAD_MODEL_CHAP_16_04 (0)
#define LOAD_MODEL_CHAP_17_01 (1)
...
#endif // #if LOAD_MODEL_CHAP_16_03
#if LOAD_MODEL_CHAP_16_04
		handleInputInternal(Models::Chapter::k16_04);
#endif // #if LOAD_MODEL_CHAP_16_04
#if LOAD_MODEL_CHAP_17_01
		handleInputInternal(Models::Chapter::k17_01);
#endif // #if LOAD_MODEL_CHAP_17_01
}
...
void Models::handleInputInternal(Chapter chapter)
{
	...
	case Chapter::k16_04: s_iModels->handleInput(); break;
	case Chapter::k17_01: s_iModels->handleInput(); break;
	default: break;
	}
}
